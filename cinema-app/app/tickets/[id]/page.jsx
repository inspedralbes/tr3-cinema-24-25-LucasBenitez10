...
import { Calendar, Clock, Map, Users, Tag, Download, Printer, ArrowLeft, Check } from 'lucide-react';
          ...
          <div className="p-6">
            <div className="flex flex-col lg:flex-row">
              ...
              <div className="lg:w-1/3 flex flex-col items-center mb-6 lg:mb-0">
                ...
                <p className="mt-2 text-xs text-gray-500 text-center">Código: {ticket.ticketCode || ticket._id}</p>
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900">{formatTime(ticket.screening?.startTime)}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900">{ticket.pricePaid ? `${ticket.pricePaid.toFixed(2)} €` : 'No disponible'}</p>
                    </div>
                  </div>

                  {ticket.ticketTypeCode && (
                    <div className="flex items-start">
                      <Check className="flex-shrink-0 h-5 w-5 text-red-600 mt-0.5 mr-3" />
                      <div>
                        <p className="text-sm font-medium text-gray-700">Tipo de entrada</p>
                        <p className="text-gray-900">{ticket.ticketTypeCode === 'normal' ? 'Normal' : 
                                                     ticket.ticketTypeCode === 'reduced' ? 'Reducida' : 
                                                     ticket.ticketTypeCode}</p>
                      </div>
                    </div>
                  )}
                </div>
